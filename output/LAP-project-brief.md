...
- **Two interoperating implementations** — a zero-dependency Node library (49/49 tests) and a Python port with FastMCP middleware (38/38) — proven byte-identical against shared test vectors.
