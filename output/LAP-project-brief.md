...
- **A zero-dependency reference library** (Node ≥20): 33/33 tests green, including cross-language proof that Python and JavaScript produce byte-identical canonical signatures.
